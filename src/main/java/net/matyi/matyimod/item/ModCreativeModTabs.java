...
public class ModCreativeModTabs {
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS =
        DeferredRegister.create(Registries.CREATIVE_MODE_TAB, matyimod.MOD_ID);

    public static final RegistryObject<CreativeModeTab> MATYI_TAB = CREATIVE_MODE_TABS.register("matyi_mod_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.SAPPHIRE.get()))
                    .title(Component.translatable("creativetab.matyimod_tab"))

package net.matyi.matyimod.entity.client;

import com.mojang.blaze3d.vertex.PoseStack;
import net.matyi.matyimod.entity.custom.RhinoEntity;
...
public class RhinoRenderer extends MobRenderer<RhinoEntity, RhinoModel<RhinoEntity>> {
    ...
    public ResourceLocation getTextureLocation(RhinoEntity pEntity) {
        return new ResourceLocation(matyimod.MOD_ID, "textures/entity/rhino.png");
    }
